#=====================================================================================================
# Script Name: 4b_Generate_KML_and_Shapefiles_BOOTS.R
# Script Function: This script reads in the .CSV files created from "4_Append SeaBird CTD Data to NAV Exports.R".
...
for(k in 1:length(Dives2))
{
  ...
  colnames(coords1) <- c("Beacon_Long_smooth","Beacon_Lat_smooth") #MUST HAVE LONGS BEFORE LATS
  colnames(coords2) <- c("Beacon_Long_interp","Beacon_Lat_interp") #MUST HAVE LONGS BEFORE LATS
...
######################################CREATE A SPATIAL POINTS DATA FRAME FOR EACH TRANSECT######################
